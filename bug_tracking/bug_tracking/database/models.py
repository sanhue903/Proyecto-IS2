...
class Programador(models.Model):
    ...
    nombre_programador = models.CharField(
        max_length=255, null=False, verbose_name='Nombre del programador')

    def __str__(self):
        return str(self.nombre_programador)
...
class Proyecto(models.Model):
    ...
    nombre_proyecto = models.CharField(
        max_length=255, null=False, verbose_name='Nombre del proyecto')
...
class Cargo(models.Model):
    id_programador = models.ForeignKey(
        Programador, null=False, on_delete=models.CASCADE)
    ...
    cargo = models.CharField(max_length=255, null=False,
                             verbose_name='Cargo en el proyecto')
...
class Bug(models.Model):
    ...
    id_proyecto = models.ForeignKey(
        Proyecto, null=False, on_delete=models.CASCADE, verbose_name='Proyecto')
    id_programador = models.ForeignKey(
        Programador, null=False, on_delete=models.CASCADE, verbose_name='Programador')
...
class ReporteBug(models.Model):
    ...
    correo_usuario = models.ForeignKey(
        Usuario, null=False, on_delete=models.CASCADE, related_name='reportes')
    id_bug = models.ForeignKey(
        Bug, blank=True, null=True, on_delete=models.CASCADE, verbose_name='Bug')

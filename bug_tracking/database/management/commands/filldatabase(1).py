...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        reporte1 = ReporteBug.objects.create(titulo='Reporte 1', reporte='Reporte sobre el carrito de comprar, no funciona',id_usuario=usuario.usuario, id_proyecto=proyecto1)
        reporte1.save()

        reporte2 = ReporteBug.objects.create(titulo='Reporte 2', reporte='Reporte sobre el inicio de sesión en nuevos dispositivos', estado=ReporteBug.ESTADOS_CHOICES[2][0], id_usuario=usuario2.usuario, id_proyecto=proyecto2)
        reporte2.save()

        reporte3 = ReporteBug.objects.create(titulo='Reporte 3', reporte='Reporte sobre el la funcion para pedir de horas', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug3, id_proyecto=proyecto1)
        reporte3.save()

        reporte4 = ReporteBug.objects.create(titulo='Reporte 4', reporte='Reporte de adjuntar archivos al correo', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug4, id_proyecto=proyecto2)
        reporte4.save()

        reporte5 = ReporteBug.objects.create(titulo='Reporte 5', reporte='Reporte sobre el la funcion para pedir de horas', id_usuario=usuario.usuario, id_proyecto=proyecto3)
        reporte5.save()

        reporte6 = ReporteBug.objects.create(titulo='Reporte 6', reporte='Reporte sobre el momento de recibir un pago',estado=ReporteBug.ESTADOS_CHOICES[2][0], id_usuario=usuario2.usuario, id_proyecto=proyecto1)
        reporte6.save()

        reporte7 = ReporteBug.objects.create(titulo='Reporte 7', reporte='Reporte de la veficacion de las cuentas', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug7, id_proyecto=proyecto3)
        reporte7.save()
        ...
        reporte16 = ReporteBug.objects.create(titulo='Reporte 16', reporte='Reporte sobre el formulario de contactos ', estado=ReporteBug.ESTADOS_CHOICES[2][0], id_usuario=usuario1.usuario, id_bug=bug16, id_proyecto=proyecto2)
        reporte16.save()

        reporte17 = ReporteBug.objects.create(titulo='Reporte 17', reporte='Reporte de la pagina de perfil repetida y en mal estado ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario2.usuario, id_bug=bug17, id_proyecto=proyecto4)
        reporte17.save()
        ...
        reporte21 = ReporteBug.objects.create(titulo='Reporte 21', reporte='Reporte sobre la busqueda en el sistema ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario2.usuario, id_bug=bug21, id_proyecto=proyecto3)
        reporte21.save()

        reporte22 = ReporteBug.objects.create(titulo='Reporte 22', reporte='Reporte en la carga de archivos, no permiten los de gran tamaño ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug22, id_proyecto=proyecto2)
        reporte22.save()

        reporte23 = ReporteBug.objects.create(titulo='Reporte 23', reporte='Reporte sobre un bloqueo aleatorio a ciertas secciones del sistema ', estado=ReporteBug.ESTADOS_CHOICES[2][0], id_usuario=usuario.usuario, id_bug=bug23, id_proyecto=proyecto4)
        reporte23.save()
        ...
        reporte27 = ReporteBug.objects.create(titulo='Reporte 27', reporte='Reporte genera errores y muentra una pagina en blanco ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario.usuario, id_bug=bug27, id_proyecto=proyecto3)
        reporte27.save()

        reporte28 = ReporteBug.objects.create(titulo='Reporte 28', reporte='Reporte de un error 404 ', estado=ReporteBug.ESTADOS_CHOICES[2][0], id_usuario=usuario1.usuario, id_bug=bug28, id_proyecto=proyecto1)
        reporte28.save()

        reporte29 = ReporteBug.objects.create(titulo='Reporte 29', reporte='Reporte sobre que no se puede iniciar sesión ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario2.usuario, id_bug=bug29, id_proyecto=proyecto4)
        reporte29.save()
        ...
        reporte33 = ReporteBug.objects.create(titulo='Reporte 33', reporte='Reporte en la funcion de autocompletado ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario2.usuario, id_bug=bug33, id_proyecto=proyecto4)
        reporte33.save()

        reporte34 = ReporteBug.objects.create(titulo='Reporte 34', reporte='Reporte en la opción de menu principal ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug34, id_proyecto=proyecto1)
        reporte34.save()

        reporte35 = ReporteBug.objects.create(titulo='Reporte 35', reporte='Reporte en el guardar un archivo en el formulario ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario.usuario, id_bug=bug35, id_proyecto=proyecto2)
        reporte35.save()
        ...
        reporte42 = ReporteBug.objects.create(titulo='Reporte 42', reporte='Reporte que se esta haciendo un filtrado incorrecto ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario3.usuario, id_bug=bug42, id_proyecto=proyecto3)
        reporte42.save()

        reporte43 = ReporteBug.objects.create(titulo='Reporte 43', reporte='Reporte se muestra un mensaje de error', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario.usuario, id_bug=bug43, id_proyecto=proyecto2)
        reporte43.save()
        ...
        reporte48 = ReporteBug.objects.create(titulo='Reporte 48', reporte='Reporte sobre que no se puede editar el formulario ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario1.usuario, id_bug=bug48, id_proyecto=proyecto3)
        reporte48.save()

        reporte49 = ReporteBug.objects.create(titulo='Reporte 49', reporte='Reporte de la funcion de enviar correos ', estado=ReporteBug.ESTADOS_CHOICES[1][0], id_usuario=usuario2.usuario, id_bug=bug49, id_proyecto=proyecto4)
        reporte49.save()
        ...
        bug3 = Bug.objects.create(titulo='Bug 3', descripcion='al momento de agregar mas bebidas al inventario, la sprite no suman', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto1, id_programador=programador3.programador)
        bug3.save()
        ...
        bug5= Bug.objects.create(titulo='Bug 5', descripcion='Al momento de pedir una hora, esta no me entrega confirmacion y vuelve al inicio', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto3, id_programador=programador1.programador)
        bug5.save()

        bug6 = Bug.objects.create(titulo='Bug 6', descripcion='Cuando ya llene mi carrito de compras, cuando quiero pagar este se borra', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador1.programador)
        bug6.save()

        bug7 = Bug.objects.create(titulo='Bug 7', descripcion='Al momento de agregar el correo, la pagina no lo verifica', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto3, id_programador=programador3.programador)
        bug7.save()

        bug8 = Bug.objects.create(titulo='Bug 8', descripcion='Cuando quiero pagar, no me manda a la pagina del banco y no me deja finalizar la compra', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador5.programador)
        bug8.save()

        bug9 = Bug.objects.create(titulo='Bug 9', descripcion='El enlace de restablecimiento de contraseña no funciona correctamente y no permite a los usuarios cambiar su contraseña', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador3.programador)
        bug9.save()

        bug10 = Bug.objects.create(titulo='Bug 10', descripcion='La funcionalidad de búsqueda no muestra resultados precisos y devuelve datos incorrectos', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador1.programador)
        bug10.save()

        bug11 = Bug.objects.create(titulo='Bug 11', descripcion='La imagen de perfil del usuario no se muestra correctamente y aparece distorsionada', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador3.programador)
        bug11.save()

        bug12 = Bug.objects.create(titulo='Bug 12', descripcion='La funcionalidad de agregar productos al carrito no funciona y los artículos no se agregan correctamente', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador3.programador)
        bug12.save()

        bug13 = Bug.objects.create(titulo='Bug 13', descripcion='El proceso de pago muestra un error al ingresar los detalles de la tarjeta de crédito', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador2.programador)
        bug13.save()

        bug14 = Bug.objects.create(titulo='Bug 14', descripcion='Los usuarios no pueden iniciar sesión con sus cuentas de Google y se muestra un error de autenticación', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug14.save()

        bug15 = Bug.objects.create(titulo='Bug 15', descripcion='La funcionalidad de compartir en redes sociales no muestra los enlaces correctos y no comparte la información adecuada', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador4.programador)
        bug15.save()

        bug16 = Bug.objects.create(titulo='Bug 16', descripcion='Al enviar el formulario de contacto, los datos no se envían por correo electrónico al destinatario', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador1.programador)
        bug16.save()

        bug17 = Bug.objects.create(titulo='Bug 17', descripcion='La página de perfil del usuario muestra información incorrecta y no se actualiza correctamente', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador2.programador)
        bug17.save()

        bug18 = Bug.objects.create(titulo='Bug 18', descripcion='El botón de inicio de sesión no funciona y no permite a los usuarios acceder al sistema', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto3, id_programador=programador3.programador)
        bug18.save()

        bug19 = Bug.objects.create(titulo='Bug 19', descripcion='El botón de "Guardar cambios" no está funcionando correctamente y no guarda las modificaciones realizadas en el formulario.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto1, id_programador=programador4.programador)
        bug19.save()

        bug20 = Bug.objects.create(titulo='Bug 20', descripcion=' La página de inicio muestra contenido duplicado, lo cual genera confusión entre los usuarios.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug20.save()

        bug21 = Bug.objects.create(titulo='Bug 21', descripcion='Al realizar una búsqueda en el sistema, algunos resultados no se muestran correctamente y aparecen datos incorrectos.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto3, id_programador=programador2.programador)
        bug21.save()

        bug22 = Bug.objects.create(titulo='Bug 22', descripcion='La funcionalidad de cargar archivos no permite subir archivos de gran tamaño y muestra un mensaje de error.', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador3.programador)
        bug22.save()

        bug23 = Bug.objects.create(titulo='Bug 23', descripcion='La aplicación se bloquea aleatoriamente al intentar acceder a ciertas secciones del sistema.', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto4, id_programador=programador4.programador)
        bug23.save()

        bug24 = Bug.objects.create(titulo='Bug 24', descripcion='Los mensajes de notificación no se muestran correctamente y algunos usuarios no reciben las alertas correspondientes.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug24.save()

        bug25 = Bug.objects.create(titulo='Bug 25', descripcion='Al intentar enviar un formulario, los campos obligatorios no están siendo validados correctamente y permite enviar datos incompletos.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto2, id_programador=programador2.programador)
        bug25.save()

        bug26 = Bug.objects.create(titulo='Bug 26', descripcion=' La interfaz de usuario presenta problemas de diseño en dispositivos móviles, lo que dificulta la navegación y visualización adecuada.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto4, id_programador=programador3.programador)
        bug26.save()

        bug27 = Bug.objects.create(titulo='Bug 27', descripcion='Al realizar una acción determinada, el sistema genera un error interno del servidor y muestra una página en blanco.', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto3, id_programador=programador4.programador)
        bug27.save()
        
        bug28 = Bug.objects.create(titulo='Bug 28', descripcion='Al intentar acceder a un enlace específico, se muestra un error 404 indicando que la página no se encuentra disponible.', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador1.programador)
        bug28.save()

        bug29 = Bug.objects.create(titulo='Bug 29', descripcion=' El sistema no permite iniciar sesión con ciertos caracteres especiales en la contraseña, generando un mensaje de error incorrecto.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador2.programador)
        bug29.save()

        bug30 = Bug.objects.create(titulo='Bug 30', descripcion='Al intentar realizar una compra, el monto total se calcula incorrectamente y muestra un valor incorrecto en el resumen de la transacción.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador3.programador)
        bug30.save()

        bug31 = Bug.objects.create(titulo='Bug 31', descripcion='El sistema no guarda correctamente el historial de actividades de los usuarios, lo que dificulta el seguimiento de las acciones realizadas.', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto3, id_programador=programador4.programador)
        bug31.save()

        bug32 = Bug.objects.create(titulo='Bug 32', descripcion='Al subir una imagen como avatar de usuario, la imagen no se muestra correctamente y aparece distorsionada en la interfaz.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug32.save()

        bug33 = Bug.objects.create(titulo='Bug 33', descripcion='La función de autocompletado en un campo de búsqueda no muestra los resultados correspondientes a medida que se escriben las letras.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto4, id_programador=programador2.programador)
        bug33.save()

        bug34 = Bug.objects.create(titulo='Bug 34', descripcion='Al seleccionar una opción del menú principal, la página se carga en blanco y no muestra el contenido esperado.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto1, id_programador=programador3.programador)
        bug34.save()

        bug35 = Bug.objects.create(titulo='Bug 35', descripcion='Al intentar guardar un archivo adjunto en un formulario, el sistema genera un error de "archivo no válido" aunque cumple con los requisitos establecidos.', prioridad=Bug.PRIORIDADES_CHOICES[2][0],estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador4.programador)
        bug35.save()

        bug36 = Bug.objects.create(titulo='Bug 36', descripcion=' El sistema no muestra correctamente los acentos y caracteres especiales en los textos, generando errores de visualización y lectura.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador1.programador)
        bug36.save()

        bug37 = Bug.objects.create(titulo='Bug 37', descripcion='Al realizar una acción específica, como eliminar un elemento, el sistema no actualiza automáticamente la interfaz y muestra el elemento eliminado.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto3, id_programador=programador2.programador)
        bug37.save()

        bug38 = Bug.objects.create(titulo='Bug 38', descripcion='Al intentar realizar una exportación de datos, el archivo descargado está vacío o presenta información incompleta.', prioridad=Bug.PRIORIDADES_CHOICES[2][0],estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador3.programador)
        bug38.save()

        bug39 = Bug.objects.create(titulo='Bug 39', descripcion='El sistema no valida correctamente los formatos de fecha ingresados y permite introducir fechas inválidas.', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto3, id_programador=programador4.programador)
        bug39.save()

        bug40 = Bug.objects.create(titulo='Bug 40', descripcion='Al cargar un video en el sistema, el reproductor no reproduce el archivo correctamente y muestra un mensaje de error.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug40.save()

        bug41 = Bug.objects.create(titulo='Bug 41', descripcion='La función de generación de informes no muestra todos los datos requeridos y omite cierta información en el archivo generado.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador2.programador)
        bug41.save()

        bug42 = Bug.objects.create(titulo='Bug 42', descripcion='Al realizar una operación de filtrado en una tabla de datos, algunos elementos no se muestran correctamente y se omiten del resultado.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto3, id_programador=programador3.programador)
        bug42.save()

        bug43 = Bug.objects.create(titulo='Bug 43', descripcion='El sistema muestra un mensaje de error genérico al intentar realizar una acción sin proporcionar la información necesaria, lo que dificulta la identificación del problema.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto2, id_programador=programador4.programador)
        bug43.save()

        bug44 = Bug.objects.create(titulo='Bug 44', descripcion='Al realizar una búsqueda por categoría en un sistema de e-commerce, no se muestran todos los productos correspondientes a la categoría seleccionada.', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto1, id_programador=programador1.programador)
        bug44.save()

        bug45 = Bug.objects.create(titulo='Bug 45', descripcion='El sistema no guarda correctamente las preferencias de idioma del usuario y muestra el idioma predeterminado en lugar de la selección realizada.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto3, id_programador=programador2.programador)
        bug45.save()

        bug46 = Bug.objects.create(titulo='Bug 46', descripcion='Al crear un nuevo usuario, el sistema permite ingresar una contraseña débil sin mostrar un mensaje de advertencia.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador3.programador)
        bug46.save()

        bug47 = Bug.objects.create(titulo='Bug 47', descripcion='Al intentar guardar una publicación en un blog, el sistema no muestra los estilos de formato aplicados y muestra el texto sin formato.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto4, id_programador=programador4.programador)
        bug47.save()

        bug48 = Bug.objects.create(titulo='Bug 48', descripcion='Al realizar una acción de edición en un formulario, algunos campos no se guardan correctamente y muestran valores anteriores.', prioridad=Bug.PRIORIDADES_CHOICES[3][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto3, id_programador=programador1.programador)
        bug48.save()

        bug49 = Bug.objects.create(titulo='Bug 49', descripcion='La función de envío de correos electrónicos no se ejecuta correctamente y los usuarios no reciben las notificaciones correspondientes.', prioridad=Bug.PRIORIDADES_CHOICES[2][0], estado=Bug.ESTADOS_CHOICES[1][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug49.save()

        bug50 = Bug.objects.create(titulo='Bug 50', descripcion='Al intentar realizar una importación masiva de datos, el sistema muestra un error de "archivo no encontrado" aunque el archivo esté presente.', prioridad=Bug.PRIORIDADES_CHOICES[0][0], estado=Bug.ESTADOS_CHOICES[2][0], id_proyecto=proyecto2, id_programador=programador2.programador)
        bug50.save()

        bug51 = Bug.objects.create(titulo='Bug 51', descripcion='Al seleccionar una opción del menú desplegable, la lista de opciones se despliega detrás de otros elementos y no es visible para el usuario.', prioridad=Bug.PRIORIDADES_CHOICES[1][0], estado=Bug.ESTADOS_CHOICES[0][0], id_proyecto=proyecto4, id_programador=programador1.programador)
        bug51.save()

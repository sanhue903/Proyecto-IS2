    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_reporte', models.DateField(auto_now_add=True, verbose_name='fecha del caso')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('PENDIENTE', 'reporte en estado pendiente'), ('APROBADO', 'reporte aprobado'), ('DESAPROBADO', 'reporte desaprobado')], default='PENDIENTE', max_length=50, verbose_name='estado del reporte')),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('APROBADO', 'Aprobado'), ('DESAPROBADO', 'Desaprobado')], default='PENDIENTE', max_length=50, verbose_name='estado del reporte')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(verbose_name='razones de la solicitud de reasignación')),
                ('estado', models.CharField(choices=[('PENDIENTE', 'Pendiente'), ('APROBADO', 'Aprobada'), ('DESAPROBADO', 'Desaprobada')], default='PENDIENTE', max_length=50, verbose_name='Estado')),
                ('fecha_reasignacion', models.DateTimeField(auto_now_add=True, verbose_name='fecha de la petición')),
                ('id_bug', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='database.bug', verbose_name='caso asociado')),
                ('id_programador_final', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programadores_reasignados', related_query_name='programador_reasignado', to='database.programador', verbose_name='programador reasignado')),
                ('id_programador_inicial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programadores_iniciales', related_query_name='programador_inicial', to='database.programador', verbose_name='programador que solicita reasignación')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_notificacion', models.DateTimeField(auto_now_add=True, verbose_name='fecha')),
        ...
        migrations.AddField(
            model_name='bug',
            name='id_proyecto',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='database.proyecto', verbose_name='Proyecto'),
        ),
        migrations.CreateModel(
            name='Avances',
            fields=[
